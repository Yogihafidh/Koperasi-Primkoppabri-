...
<body>
    ...
    <aside class="sidebar sidebar-small">
        ...
        <ul class="sidebar-links">
            ...
            <li class="sidebar-link logout"><a href="" class="link">Logout</a></li>
        </ul>
    </aside>
</body>
