...
<body>
        ...
        <main class="content">
            ...
            <nav class="navigation">
                ...
                <button class="btn-add-transaksi btn-add-nasabah" type="button">
                    <svg width="12" height="12" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    ?>
                        <div class="nasabah">
                            ...
                            <div class="right-box-nasabah">
                                <div>
                                    <a href="?mod=editNasabah&id=<?php echo $data['nasabah_id']; ?>" class="btn-update-data btn-update-data-nasabah">
                                    ...
                                    <a href="?mod=hapusNasabah&id=<?php echo $data['nasabah_id']; ?>" class="btn-delete-data">
    ...
    <section class="error modal-tambah-data-nasabah hidden">
        <svg class="btn-close-nasabah btn-close" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
