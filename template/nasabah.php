...
<body>
    <div class="container">
        ...
        <main class="content">
            ...
            <nav class="navigation">
                ...
                <button class="btn-add-transaksi" type="button">
    ...
    <div class="">
        ...
        <section class="error tambah-data-nasabah">
            <p class="error-heading">Tambah Nasabah</p>
            <form action="" method="POST">
                ...
                <button class="btn btn-login-registrasi" type="submit">Tambah Data</button>
            </form>
        </section>
    </div>
</body>
