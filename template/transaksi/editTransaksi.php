            ...
            ?>
                ...
                <form action="" method="POST">
                    ...
                    <div class="form-input">
                        ...
                        <input type="number" placeholder="ID Nasabah" name="nasabah_id" required type="number" value="<?= $data['nasabah_id'] ?>">
                    </div>
                    ...
                    <div class="form-input">
                        ...
                        <input type="number" placeholder="Nominal" name="nominal" required type="number" value="<?= $data['nominal'] ?>">
                    </div>
