        ...
        <main class="content">
            ...
            <nav class="navigation">
                ...
                <div class="right-box-nav">
                    <svg class="icon-btn-mobile btn-close-mobile-nav" name="btn-close" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                    ...
                    <button class="btn-add-transaksi" type="button" data-toggle="modal" data-target="#tambahTransaksiModal">
                        <div class="svg-container">
                            <svg class="icon" width="12" height="12" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <path d="M23.5,9.375L15.625,9.375L15.625,1.5C15.625,0.57 14.805,-0.25 13.875,-0.25L12.125,-0.25C11.141,-0.25 10.375,0.57 10.375,1.5L10.375,9.375L2.5,9.375C1.516,9.375 0.75,10.195 0.75,11.125L0.75,12.875C0.75,13.859 1.516,14.625 2.5,14.625L10.375,14.625L10.375,22.5C10.375,23.484 11.141,24.25 12.125,24.25L13.875,24.25C14.805,24.25 15.625,23.484 15.625,22.5L15.625,14.625L23.5,14.625C24.43,14.625 25.25,13.859 25.25,12.875L25.25,11.125C25.25,10.195 24.43,9.375 23.5,9.375Z" fill="#FFFFFF" />
                            </svg>
                        </div>
                        <span>Tambah</span>
                    </button>
